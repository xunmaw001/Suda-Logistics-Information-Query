    ...
    <view class="content">
        ...
        <view class="list">
            ...
            <view v-for="item in menuList" v-bind:key="item.roleName">
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                :style='{"backgroundColor":"#fff","borderColor":"#f06f4f","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 0 60rpx"}'
                                @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li"
                                hover-class="hover">
                            <view :style='{"color":"#f06f4f","fontSize":"28rpx"}' class="text">
                                {{child.menu}}</view>
                            <view class="cuIcon-right" :style='{"color":"#f06f4f","fontSize":"28rpx"}'>
                            </view>
                        </view>
                    </view>
                </view>
			...
			<view @tap="onPageTap('../forum/forum-my')"
                ...
                <view class="text" :style='{"color":"#f06f4f","fontSize":"28rpx"}'>我的发贴</view>
                <!-- <image class="to" :style='{"color":"#f06f4f","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                <view class="cuIcon-right" :style='{"color":"#f06f4f","fontSize":"28rpx"}'></view>
            </view>
